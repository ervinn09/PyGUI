function errorPat = genErrPttrn_v02(plcMode, nFrames, errorRate, tLossLocation, nLostFrames, frameLength, codecDelay, fs, tmp_err_pttrn, stateVarFileName)

if strcmp(plcMode,'noloss')
    errorRate = 0;
end
